        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <?php 
              ...
              <a class="nav-link" href="opinion.php">Administrateur</a>
            </li>';  
              }
            ?>
      ...
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          <div class="post-preview">
            <a href="post.html">
            <h2 class="post-title">Les essais de Soheil Ayari </h2>
            <h3 class="post-subtitle"> Alfa Romeo 4C vs Apline A110 vs Porsche Cayman</h3>
            </a>
            <p class="post-meta">Publié par
              <a href="#">NKS 5 </a>
              le 27 Décembre 2018</p>
          </div>
          <hr>
